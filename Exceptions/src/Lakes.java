public class Lakes extends Edge{
    ...
    public static boolean edgeValidator(String fromEdge,String ToEdge,String EdgeType, String EdgeName, String Length, String Speed,String width,String tidalLevel,String depth){
        if(Edge.edgeValidator(fromEdge,ToEdge,EdgeType,EdgeName, Length, Speed)){
            if(Integer.parseInt(tidalLevel)>0 && Integer.parseInt(tidalLevel)<=15)
                return true;
            else {
