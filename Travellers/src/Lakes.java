...
//        super.CalculateCost();
    ...
    public void printEdge(){
        System.out.println(super.getFromEdge()+" "+super.getToEdge()+" "+super.getEdgeName()+" "+super.getLength()+" "+super.getSpeed()+" "+width+" "+tidalLevel+" "+depth);//+ " " + super.CostNew + " " + super.getCost()+ " " + super.getVeff()+ " " + super.VeffNew);
    }
}
