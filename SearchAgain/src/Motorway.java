...
//        System.out.println("Veff:"+" "+temp);
    ...
    public void printEdge(){
        System.out.println(super.getFromEdge()+" "+super.getToEdge()+" "+super.getEdgeName()+" "+super.getLength()+" "+super.getSpeed()+" "+TollPrice+" "+ LaneNO +" "+ MaintenanceLevel+" "+ occupancy);//+ " " + distance);//+ " " + super.CostNew + " " + super.getCost()+ " " + super.getVeff()+ " " + super.VeffNew);
    }
}
