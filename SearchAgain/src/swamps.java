public class swamps extends Edge {
    ...
    public void printEdge(){
        System.out.println(super.getFromEdge()+" "+super.getToEdge()+" "+super.getEdgeName()+" "+super.getLength()+" "+super.getSpeed()+" "+difficulty);//+ " " + distance);//+ " " + super.CostNew + " " + super.getCost()+ " " + super.getVeff()+ " " + super.VeffNew);
    }
}
